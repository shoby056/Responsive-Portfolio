        ...
        <div className="Home-container">
          <div className="home-left">
            ...
            <div className="btn-container">
              <Link href="#projects"><button className="btnn">Projects</button></Link>
            </div>
      ...
      <section id="about">
        <div className="about-us">
          ...
          <p className="about-me-description">
            Here you will find more information about me, what I do, and my current skills<br/> mostly in terms of programming and technology
          </p>
          ...
          <div className="bottom-parent">
            <div className="left-side">
              ...
              <div className="button-about">
                <Link href="#contact"><button className="shani">CONTACT</button></Link>
              </div>
            </div>
        ...
        <div className="projects">
          ...
          <div className="projects-bottom-parent">
            <div className="projects-bottom-left-side">
              ...
              <p className="projects-bottom-left-description">
                This tool calculates your current age based on your date of birth. It shows your age in years, months, and days.
              </p>
          ...
          <div className="projects-bottom-parent">
            <div className="projects-bottom-left-side">
              ...
              <p className="projects-bottom-left-description">
                This tool creates strong and secure passwords to enhance your online security. It allows you to customize the length and complexity of the password, 
                ensuring it's difficult to guess while remaining easy for you to remember.
              </p>
              <div className="button-container">
                <Link href="https://shoby-js-tasks.vercel.app/Random%20password%20generator/index.html" target="_blank">
                  <button className="live-link">Live Link</button>
                </Link>
              </div>
            </div>
...
{/* Contact Us */}
      <section id="contact">
        <div className="contact-us">
          ...
          <p className="contact-us-description">Feel free to Contact me by submitting the form below and I will get back to you as soon as possible</p>
